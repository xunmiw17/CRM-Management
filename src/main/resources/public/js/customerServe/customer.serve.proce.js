layui.use(['table','layer', 'form'],function() {
    ...
    let tableIns = table.render({
        ...
        url: '/crm' + '/customer_serve/list?state=fw_002&flag=1',
        cellMinWidth: 95,
        page: true,
        height: "full-125",
        limits: [10, 15, 20, 25],
    ...
    function openCustomerServeProceDialog(id) {
        let title = "<h3>Serve Management - Handling a service</h3>";
        let url = "/crm" + "/customer_serve/toCustomerServeProcePage?id=" + id;
