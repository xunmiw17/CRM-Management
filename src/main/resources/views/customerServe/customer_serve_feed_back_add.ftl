...
<form class="layui-form" style="width:80%;">
        ...
        <div class="layui-col-xs6">
            ...
            <div class="layui-input-block">
                <select name="serveType" id="serveType" disabled="disabled">
                    ...
                    <option value="6" <#if customerServe.serveType=="6">selected="selected"</#if>>查询</option>
    ...
    <div class="layui-form-item layui-row">
        ...
        <div class="layui-col-xs6">
            ...
            <div class="layui-input-block">
                <input type="text" class="layui-input" lay-verify="required" name="assignTime"
    ...
    <div class="layui-form-item layui-row">
        <div class="layui-col-xs6">
            ...
            <div class="layui-input-block">
                <input type="text" class="layui-input" name="serviceProceResult"
                       id="serviceProceResult">
            </div>
        </div>
        <div class="layui-col-xs6">
...
<script type="text/javascript" src="/crm/js/customerServe/customer.serve.feed.back.add.js"></script>
</body>
</html>