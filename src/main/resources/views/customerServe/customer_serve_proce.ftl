...
<form class="layui-form" >
    ...
    <script id="customerServeListBar" type="text/html">
        <a href="javascript:;" class="layui-btn layui-btn-xs layui-btn-normal" lay-event="proce">处理</a>
    </script>

</form>
<script type="text/javascript" src="/crm/js/customerServe/customer.serve.proce.js"></script>
</body>
</html>