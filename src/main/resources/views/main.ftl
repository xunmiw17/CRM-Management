        ...
        <ul class="layui-nav layui-layout-right">
            ...
            <li class="layui-nav-item layuimini-setting">
                ...
                <dl class="layui-nav-child">
                    <dd>
                        <a href="javascript:;" data-iframe-tab="/crm/user/toSettingPage" data-title="基本资料" data-icon="fa fa-gears">基本资料</a>
                    </dd>
                    <dd>
                        <!-- "toPasswordPage" is a path which is added to a backend method  -->
        ...
        <div class="layui-side-scroll layui-left-menu">
            <#if permissions??>
                <ul class="layui-nav layui-nav-tree layui-left-nav-tree layui-this" id="currency">
                    <!-- Use the freemarker function to determine if a certain menu is available for the user -->
