                ...
                <#if customerLoss.state==1>
                    <div class="layui-form-item layui-row">
                        <div class="layui-col-xs6">
                            ...
                            <div class="layui-input-block">
                                <input type="text" class="layui-input"
                                       name="confirmLossTime" value="${(customerLoss.confirmLossTime?string("yyyy-MM-dd HH:mm:ss"))!}" readonly="readonly">
                            </div>
                        </div>
                        <div class="layui-col-xs6">
...
<script type="text/javascript" src="/crm/js/customerLoss/customer.rep.js"></script>
</body>
</html>